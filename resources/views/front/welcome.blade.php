...
<head>
  ...
  <link href="{{ asset('css/front/assets/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
  ...
  <!-- Vendor CSS Files -->
  <link href="{{ asset('css/front/assets/vendor/bootstrap/css/bootstrap.rtl.min.css') }}" rel="stylesheet">
...
<body class="index-page" dir="rtl">
    ...
    <div class="branding d-flex align-items-cente">
      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        <a href="index.html" class="logo d-flex align-items-center">
          ...
          <h1 class="sitename">سفارة جمهورية السودان </h1>
        </a>

        <nav id="navmenu" class="navmenu">
          <ul>
            <li><a href="#hero" class="active">الرئيسية</a></li>
            <li><a href="#about">دخول</a></li>
        ...
        <div class="container">
          <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="100">
            <div class="col-lg-8 text-center">
              <h2>خدمة حجز موعد</h2>
              <p>    </p>
              <a href="#featured-services" class="btn-get-started"> حجز موعد  </a>
            </div>
          </div>
        </div>
      </div>
  ...
  <script src="{{ asset('css/front/assets/assets/vendor/php-email-form/validate.js') }}"></script>
